...
var Accordion = React13.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React13.useState(props.id), _React$useState2 = _slicedToArray3(_React$useState, 2), idState = _React$useState2[0], setIdState = _React$useState2[1];
  var _React$useState3 = React13.useState(props.activeIndex), _React$useState4 = _slicedToArray3(_React$useState3, 2), activeIndexState = _React$useState4[0], setActiveIndexState = _React$useState4[1];
  var elementRef = React13.useRef(null);
  var activeIndex = props.onTabChange ? props.activeIndex : activeIndexState;
  var count = React13.Children.count(props.children);
  var metaData = {
    props,
    state: {
      id: idState,
  ...
  var _AccordionBase$setMet = AccordionBase.setMetaData(_objectSpread4({}, metaData)), ptm = _AccordionBase$setMet.ptm, ptmo = _AccordionBase$setMet.ptmo, cx = _AccordionBase$setMet.cx, isUnstyled = _AccordionBase$setMet.isUnstyled;
  ...
  var getTabPT = function getTabPT2(tab, key, index) {
    ...
    return mergeProps2(ptm("tab.".concat(key), {
      tab: tabMetaData
    ...
    if (!getTabProp(tab, "disabled")) {
      ...
      if (props.multiple) {
        ...
        newActiveIndex = selected ? indexes.filter(function(i) {
          return i !== index;
        }) : [].concat(_toConsumableArray3(indexes), [index]);
      } else {
  ...
  var createTabHeader = function createTabHeader2(tab, selected, index) {
    var style = _objectSpread4(_objectSpread4({}, getTabProp(tab, "style") || {}), getTabProp(tab, "headerStyle") || {});
    ...
    var header2 = getTabProp(tab, "headerTemplate") ? ObjectUtils.getJSXElement(getTabProp(tab, "headerTemplate"), tabCProps) : React13.createElement("span", headerTitleProps, ObjectUtils.getJSXElement(getTabProp(tab, "header"), tabCProps));
    var headerIconProps = mergeProps2({
      "aria-hidden": "true",
      className: cx("accordiontab.headericon")
    }, getTabPT(tab, "headericon", index));
    var icon = selected ? props.collapseIcon || React13.createElement(ChevronDownIcon, headerIconProps) : props.expandIcon || React13.createElement(ChevronRightIcon, headerIconProps);
    var toggleIcon = IconUtils.getJSXIcon(icon, _objectSpread4({}, headerIconProps), {
      props,
      selected
    });
    ...
    return React13.createElement("div", headerProps, React13.createElement("a", headerActionProps, toggleIcon, header2));
  };
  var createTabContent = function createTabContent2(tab, selected, index) {
    var style = _objectSpread4(_objectSpread4({}, getTabProp(tab, "style") || {}), getTabProp(tab, "contentStyle") || {});
    var contentId = idState + "_content_" + index;
    var ariaLabelledby = idState + "_header_" + index;
    var contentRef = React13.createRef();
    var toggleableContentProps = mergeProps2({
      id: contentId,
      ref: contentRef,
    ...
    return React13.createElement(CSSTransition2, _extends5({
      nodeRef: contentRef
    }, transitionProps), React13.createElement("div", toggleableContentProps, React13.createElement("div", contentProps, getTabProp(tab, "children"))));
  };
  var createTab = function createTab2(tab, index) {
    if (ObjectUtils.isValidChild(tab, "AccordionTab")) {
      ...
      var _rootProps = mergeProps2({
        key,
        className: cx("accordiontab.root", {
          selected
        })
      }, AccordionTabBase.getCOtherProps(tab), getTabPT(tab, "root", index));
      return React13.createElement("div", _rootProps, tabHeader, tabContent);
    }
    return null;
  };
  var createTabs = function createTabs2() {
    return React13.Children.map(props.children, createTab);
  };
  var tabs = createTabs();
  ...
  return React13.createElement("div", _extends5({
    id: idState,
    ref: elementRef
  }, rootProps), tabs);
});
